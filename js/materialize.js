    ...
    function(a) {
        ...
        function f(a) {
            ...
            for (var b = null, c = a.target || a.srcElement; null !== c.parentElement;) {
                if (!(c instanceof SVGElement || c.className.indexOf("waves") === -1)) {
                    b = c;
                    break
                }
                if (c.classList.contains("waves")) {
                    b = c;
                    break
                }
                c = c.parentElement
                ...
                wrapInput: function(a) {
                    for (var b = 0; b < a.length; b++) {
                        ...
                        if ("input" === c.tagName.toLowerCase()) {
                            var d = c.parentNode;
                            if ("i" === d.tagName.toLowerCase() && d.className.indexOf("waves") !== -1) continue;
        ...
        h.displayEffect = function(b) {
            b = b || {}, "duration" in b && (j.duration = b.duration), j.wrapInput(i(".waves")), "ontouchstart" in a && document.body.addEventListener("touchstart", g, !1), document.body.addEventListener("mousedown", g, !1)
        }, h.attach = function(b) {
