...
class oled:
    ...
    def greeting(self):
        self.oled.text('Welcome to ..',0,0)
        self.oled.text('White Arrow 1.0',0,16)
        self.oled.text('based on',0,32)
        self.oled.text('Micropython',0,40)
        self.oled.show()
    ...
    def connected(self):
        ...
        time.sleep_ms(500)
        self.oled.fill(0)
        self.oled.text('Hello there !',0,16)
        self.oled.text('Archer',0,32)
        self.oled.show()

    def finished(self,f_program):
        self.oled.text('Finish running..',0,0)
        self.oled.text(f_program,0,8)
        self.oled.show()
        time.sleep_ms(500)
        self.oled.fill(0)
        self.oled.text('White--Arrow >>',0,16)
        self.oled.text('Status: Ready',0,32)
        self.oled.show()
